...
export const Hire = () => {
  ...
  //todo 2) затемнение текста в скилах (не применяется к тексту на ios)
  // 4) бургер меню, 5) страница проектов, 6) мб анимация скроллинга, 7) анимация отрисовки полоски в хедере(как анимировать если обычный скролл) и мб анимация скейлинга
