...
export const Hire = () => {
  ...
  //todo 1) не виден лоадер, переделать! 2) затемнение текста в скилах (не применяется к тексту на ios) 3) центрирование letsconnect кнопок, 4) бургер меню, 5) страница проектов, 6) мб анимация скроллинга, 7) анимация отрисовки полоски в хедере и мб анимация скейлинга
